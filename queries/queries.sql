...
SELECT p.apellido1, p.apellido2, p.nombre FROM profesor prof LEFT JOIN persona p FORCE INDEX (PRIMARY) ON p.id = prof.id_profesor WHERE prof.id_departamento IS NULL;
