...
SELECT d.nombre, COUNT(prof.id_profesor) AS 'total' FROM departamento d INNER JOIN profesor prof ON prof.id_departamento = d.id GROUP BY d.nombre ORDER BY total DESC;
