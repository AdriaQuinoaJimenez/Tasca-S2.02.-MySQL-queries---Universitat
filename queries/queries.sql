...
SELECT d.nombre AS 'departamento', p.apellido1, p.apellido2, p.nombre FROM persona p LEFT JOIN profesor prof ON p.id = prof.id_profesor LEFT JOIN departamento d ON d.id = prof.id_departamento ORDER BY d.nombre, p.apellido1, p.apellido2, p.nombre;
