...
SELECT p.apellido1, p.apellido2, p.nombre FROM profesor prof LEFT JOIN persona p ON prof.id_profesor = p.id LEFT JOIN departamento d ON prof.id_departamento = d.id WHERE prof.id_departamento IS NULL;
